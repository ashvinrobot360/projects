...
def train_CNN(train_directory, target_size=(200, 200), classes=None, batch_size=128, num_epochs=20, num_classes=5, verbose=0):
    """
...
train_dir = "/home/ashvin/Desktop/KerasImages/Flowers/flowers"
trained_model=train_CNN(train_directory=train_dir,classes=['daisy','rose','tulip', 'dandelion', 'sunflower'], num_epochs=30,num_classes=5,verbose=1)
trained_model.save("/home/ashvin/PycharmProjects/Keras/flower_model.h5")